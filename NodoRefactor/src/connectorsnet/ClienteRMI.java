/*
 * Esta clase se usa para obtener el registro rmi del supernodo y poder hacer 
diferentes operaciones  con el super nodo.
 * (Update files, remove files, enviar resfresh de estado activo)
 */
